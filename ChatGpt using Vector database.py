...
class VoiceAssistant:
    def _init_(self, model_path):
        self.openai_api_key = "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"  # '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' Replace with your OpenAI API key
        openai.api_key = self.openai_api_key
        self.model = vosk.Model("C:/Users/jimve/Documents/fipec/Team_Maruth/vosk-model-small-en-us-0.15")
...
# Usage example
if __name__ == "_main_":
    pdf_folder_path = "C:/Users/jimve/Documents/fipec/Team_Maruth/books"
    ...
    # Example commands
    assistant.listen()
    assistant.process_command("extract words one")